    ...
    <div>
        {isOpen && (
            <ul className='flex flex-col lg:flex-row justify-around items-center pt-10 gap-10 text-[24px] font-semibold lg:hidden'>
                ...
                <Link to="/login" className='px-4 py-2 rounded-xl border-3 border-transparent hover:border-white duration-300 '>Log in</Link>
                <Link to="/register" className='px-4 py-2 rounded-xl bg-violet-400 hover:bg-violet-500 duration-200'>Sign up</Link>
            </ul>
        )}
    </div>
    </>
