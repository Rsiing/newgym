  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center p-20 lg:w-[80%] mx-auto cursor-default'>
        ...
        <div className="flex gap-4 mt-10 font-bold xl:text-2xl lg:text-xl text-base">
            <Link to="/register" className="px-4 py-2 bg-violet-400 hover:bg-violet-500 duration-200 rounded-xl cursor-pointer">Get started</Link>
            <Link to="/about" className="cursor-pointer flex items-center">Learn More →</Link>
        </div>
    </div>
    </>
  )
