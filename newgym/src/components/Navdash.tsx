  ...
  return (
    ...
    <div className='flex justify-between items-center text-white p-4 lg:text-[40px] text-[32px] cursor-default'>   
        ...
        <div className='flex items-center lg:gap-12 gap-6 font-semibold lg:text-[32px] text-[24px]'>
            <Link to="/dashboard" className='hidden lg:flex'>Home</Link>
            <Link to="/about" className='hidden lg:flex'>My plan</Link>
            <Link to="/contact" className='hidden lg:flex'>Contact</Link>
            <Link to="/login" className='px-4 py-2 rounded-xl border-3 border-transparent hover:border-white duration-300 hidden lg:flex'>Log out</Link>
            <Link to="/account" className='px-4 py-2 rounded-xl bg-violet-400 hover:bg-violet-500 duration-200 hidden lg:flex'>Account</Link>
    ...
    <div>
        {isOpen && (
            <ul className='flex flex-col lg:flex-row justify-around items-center pt-10 gap-10 text-[24px] font-semibold lg:hidden'>
                ...
                <Link to="/account" className='px-4 py-2 rounded-xl bg-violet-400 hover:bg-violet-500 duration-200'>Account</Link>
            </ul>
        )}
    </div>
    </>
